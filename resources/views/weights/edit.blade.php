            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        {!! Form::model( $weight, [ 'route' => ['take-weights.update', $weight], 'method' => 'PUT', 'class' => 'form-horizontal form-material']) !!}

                        <div class="form-group">
                            {!! Form::label('code_id', 'Código animalito') !!}
                            <div class="col-md-12">
                                {!! Form::text('code_id', $weight->code_id, ['class' => 'form-control form-control-line', 'name' => 'code_id', 'disabled' => 'true', 'required' => 'required']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            {!! Form::label('registration_date', 'Fecha de venta') !!}
                            <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <a href="{{ url('/take-weights/'.$weight->purchase_id) }}" class="btn btn-outline-info"><i class="fa fa-arrow-left"> </i> Regresar</a>
